        ...
        <form-layout @submit.prevent="register" class="w-1/4 h-full bg-slate-50 flex flex-col justify-center space-y-4">
            ...
            <template v-slot:fields>
                <div class="px-10 space-y-4">
                    ...
                    <TextInput id="email" type="email" class="mt-1 block w-full py-1 px-2 border-2 border-green-600" v-model="form.email" required
                        autocomplete="email" autofocus />
                    <InputError :message="form.errors.email" />
                    <InputLabel for="password" value="Password" />
                    <TextInput id="password" type="password" class="mt-1 block w-full py-1 px-2 border-2 border-green-600" v-model="form.password"
